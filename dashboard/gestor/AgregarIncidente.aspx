<%@ Page Title="" Language="C#" MasterPageFile="~/dashboard/gestor/Maestra.master" AutoEventWireup="true" CodeFile="AgregarIncidente.aspx.cs" Inherits="dashboard_gestor_AgregarIncidente" %>
                ...
                <div class="row center-align">
                    <div class="container">
                        ...
                        <div class="col s12 m12 center-align">
                            <asp:Button ID="guardarIncidente" CssClass="btn blue white-text" runat="server" Text="Guardar" OnClick="guardarIncidente_Click"  />
                        </div>
